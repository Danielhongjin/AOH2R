boss_aghanim_blink = class{}

----------------------------------------------------------------------------------------

function boss_aghanim_blink:Precache( context )
...
function boss_aghanim_blink:OnSpellStart()
...
function boss_aghanim_blink:OnProjectileHit( hTarget, vLocation )
	if IsServer() then
