...
boss_aghanim_shard_attack = class( {} )
...
function boss_aghanim_shard_attack:Precache( context )
...
function boss_aghanim_shard_attack:ProcsMagicStick()
	return false
end

--------------------------------------------------------------------------------

function boss_aghanim_shard_attack:OnAbilityPhaseStart()
	if IsServer() then
...
function boss_aghanim_shard_attack:OnChannelThink( flInterval )
	if IsServer() then
...
function boss_aghanim_shard_attack:OnChannelFinish( bInterrupted )
	if IsServer() then
...
function boss_aghanim_shard_attack:OnSpellStart()
	if IsServer() then
...
function boss_aghanim_shard_attack:BeginSpirals()
	self.Projectiles = {}
...
function boss_aghanim_shard_attack:ThinkSpirals( flInterval )
...
function boss_aghanim_shard_attack:ThinkSpiralProjectile( info )
...
function boss_aghanim_shard_attack:BeginRebound()
end

-------------------------------------------------------------------------------

function boss_aghanim_shard_attack:ThinkRebound( flInterval )
end

-------------------------------------------------------------------------------

function boss_aghanim_shard_attack:ThinkReboundProjectile( info )
end

-------------------------------------------------------------------------------

function boss_aghanim_shard_attack:BeginJitter()
end

-------------------------------------------------------------------------------

function boss_aghanim_shard_attack:ThinkJitter( flInterval )
end

-------------------------------------------------------------------------------

function boss_aghanim_shard_attack:ThinkJitterProjectile( info )
end

--------------------------------------------------------------------------------

function boss_aghanim_shard_attack:LaunchCrystals( vVel, flDist, flRadius )
	local info = 
	{
		Ability = self,
...
function boss_aghanim_shard_attack:OnProjectileThinkHandle( iProjectileHandle )
	if IsServer() then
		local info = nil
...
function boss_aghanim_shard_attack:OnProjectileHitHandle( hTarget, vLocation, iProjectileHandle )
	if IsServer() then
		local info = nil
		for _,v in pairs ( self.Projectiles ) do
			if v.nHandle == iProjectileHandle then
