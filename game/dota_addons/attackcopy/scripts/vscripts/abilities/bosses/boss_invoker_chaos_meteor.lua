...
boss_invoker_chaos_meteor = class({})
LinkLuaModifier( "modifier_invoker_chaos_meteor_lua_thinker", "abilities/bosses/boss_invoker_chaos_meteor.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_invoker_chaos_meteor_lua_burn", "abilities/bosses/boss_invoker_chaos_meteor.lua", LUA_MODIFIER_MOTION_NONE )
