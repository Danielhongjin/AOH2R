...
--[[
  ...
  -Additionally, ensure that this file is placed in the vscripts/libraries path and that the vscripts/lib/modifiers/modifier_animation.lua, modifier_animation_translate.lua, and modifier_animation_translate_permanent.lua files exist and are in the correct path
